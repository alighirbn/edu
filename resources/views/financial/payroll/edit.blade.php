            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div>
                        ...
                        <form method="POST" action="{{ route('payroll.update', $payroll->url_address) }}">
                            @csrf
                            @method('patch')
                            ...
                            <input type="hidden" id="financial_month_id" name="financial_month_id"
                                value="{{ $payroll->financial_month_id }}">
                            <input type="hidden" id="financial_accountent_id" name="financial_accountent_id"
                                value="{{ $payroll->financial_accountent_id }}">
                            <input type="hidden" id="facility_id" name="facility_id"
                                value="{{ $payroll->facility_id }}">
                            ...
                            <x-text-input id="scientific_title_stage_id" type="hidden" name="scientific_title_stage_id"
                                value="{{ $employee->scientific_title_stage_id }}" />

                            <input type="hidden" id="url_address" name="url_address"
                                value="{{ $payroll->url_address }}">
                            ...
                            <div class="flex">
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <x-text-input id="nominal_salary_amount"
                                        ...
                                        value="{{ old('nominal_salary_amount') ?? $payroll->nominal_salary_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="Fixed_allowances_amount"
                                                ...
                                                value="{{ old('Fixed_allowances_amount') ?? $payroll->Fixed_allowances_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="transportation_allowances_amount"
                                                ...
                                                value="{{ old('transportation_allowances_amount') ?? $payroll->transportation_allowances_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="Certificate_allowance_amount"
                                                ...
                                                value="{{ old('Certificate_allowance_amount') ?? $payroll->Certificate_allowance_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="Position_allowance_amount"
                                                ...
                                                value="{{ old('Position_allowance_amount') ?? $payroll->Position_allowance_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="danager_allowance_amount"
                                                ...
                                                value="{{ old('danager_allowance_amount') ?? $payroll->danager_allowance_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="electric_shock_allowance_amount"
                                                ...
                                                value="{{ old('electric_shock_allowance_amount') ?? $payroll->electric_shock_allowance_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="University_service_allowance_amount"
                                                ...
                                                value="{{ old('University_service_allowance_amount') ?? $payroll->University_service_allowance_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="Scientific_title_allowance_amount"
                                                ...
                                                value="{{ old('Scientific_title_allowance_amount') ?? $payroll->Scientific_title_allowance_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="Marital_Status_allowance_amount"
                                                ...
                                                value="{{ old('Marital_Status_allowance_amount') ?? $payroll->Marital_Status_allowance_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="number_of_children_allowance_amount"
                                                ...
                                                value="{{ old('number_of_children_allowance_amount') ?? $payroll->number_of_children_allowance_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="Night_watchman_allowance_amount"
                                                ...
                                                value="{{ old('Night_watchman_allowance_amount') ?? $payroll->Night_watchman_allowance_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="Security_guard_allowance_amount"
                                                ...
                                                value="{{ old('Security_guard_allowance_amount') ?? $payroll->Security_guard_allowance_amount }}" />
                                        </div>
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="currency_difference_allowance_amount"
                                            ...
                                            value="{{ old('currency_difference_allowance_amount') ?? $payroll->currency_difference_allowance_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="Debit_increases_1_allowance_amount"
                                            ...
                                            value="{{ old('Debit_increases_1_allowance_amount') ?? $payroll->Debit_increases_1_allowance_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="Debit_increases_2_allowance_amount"
                                            ...
                                            value="{{ old('Debit_increases_2_allowance_amount') ?? $payroll->Debit_increases_2_allowance_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="Previous_salary_allowance_amount"
                                            ...
                                            value="{{ old('Previous_salary_allowance_amount') ?? $payroll->Previous_salary_allowance_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="Tuition_expenses_allowance_amount"
                                            ...
                                            value="{{ old('Tuition_expenses_allowance_amount') ?? $payroll->Tuition_expenses_allowance_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="Trustees_amount" class="w-48 block mt-1 allowances"
                                            ...
                                            value="{{ old('Trustees_amount') ?? $payroll->Trustees_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="driver_allowance_amount"
                                                ...
                                                value="{{ old('driver_allowance_amount') ?? $payroll->driver_allowance_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="agricultural_risk_allowance_amount"
                                                ...
                                                value="{{ old('agricultural_risk_allowance_amount') ?? $payroll->agricultural_risk_allowance_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="total_salary_amount" class="w-48 block mt-1" type="number"
                                            ...
                                            value="{{ old('total_salary_amount') ?? $payroll->total_salary_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="retirement_contributions_amount"
                                            ...
                                            value="{{ old('retirement_contributions_amount') ?? $payroll->retirement_contributions_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="retirement_amount" class="w-48 block mt-1 deduction"
                                                ...
                                                value="{{ old('retirement_amount') ?? $payroll->retirement_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="tax_deduction_amount" class="w-48 block mt-1 deduction"
                                            ...
                                            value="{{ old('tax_deduction_amount') ?? $payroll->tax_deduction_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="Social_Welfare_Fund_amount"
                                                ...
                                                value="{{ old('Social_Welfare_Fund_amount') ?? $payroll->Social_Welfare_Fund_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="Medical_Insurance_amount" class="w-48 block mt-1 deduction"
                                            ...
                                            value="{{ old('Medical_Insurance_amount') ?? $payroll->Medical_Insurance_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="life_insurance_amount" class="w-48 block mt-1 deduction"
                                            ...
                                            value="{{ old('life_insurance_amount') ?? $payroll->life_insurance_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="stamp_fee_amount" class="w-48 block mt-1 deduction"
                                            ...
                                            value="{{ old('stamp_fee_amount') ?? $payroll->stamp_fee_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <div class="inline-flex items-center">
                                            ...
                                            <x-text-input id="support_fund_amount" class="w-48 block mt-1 deduction"
                                                ...
                                                value="{{ old('support_fund_amount') ?? $payroll->support_fund_amount }}" />
                                        </div>
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="central_Statistical_Organization_amount"
                                            ...
                                            value="{{ old('central_Statistical_Organization_amount') ?? $payroll->central_Statistical_Organization_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_1_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_1_id') ?? $payroll->implementation_mail_1_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_1_amount"
                                            ...
                                            value="{{ old('implementation_mail_1_amount') ?? $payroll->implementation_mail_1_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_2_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_2_id') ?? $payroll->implementation_mail_2_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_2_amount"
                                            ...
                                            value="{{ old('implementation_mail_2_amount') ?? $payroll->implementation_mail_2_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_3_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_3_id') ?? $payroll->implementation_mail_3_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_3_amount"
                                            ...
                                            value="{{ old('implementation_mail_3_amount') ?? $payroll->implementation_mail_3_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_4_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_4_id') ?? $payroll->implementation_mail_4_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_4_amount"
                                            ...
                                            value="{{ old('implementation_mail_4_amount') ?? $payroll->implementation_mail_4_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_5_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_5_id') ?? $payroll->implementation_mail_5_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_5_amount"
                                            ...
                                            value="{{ old('implementation_mail_5_amount') ?? $payroll->implementation_mail_5_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_6_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_6_id') ?? $payroll->implementation_mail_6_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_6_amount"
                                            ...
                                            value="{{ old('implementation_mail_6_amount') ?? $payroll->implementation_mail_6_amount }}" />
                                ...
                                <div class="flex">
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_7_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_7_id') ?? $payroll->implementation_mail_7_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_7_amount"
                                            ...
                                            value="{{ old('implementation_mail_7_amount') ?? $payroll->implementation_mail_7_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_8_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_8_id') ?? $payroll->implementation_mail_8_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_8_amount"
                                            ...
                                            value="{{ old('implementation_mail_8_amount') ?? $payroll->implementation_mail_8_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_9_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_9_id') ?? $payroll->implementation_mail_9_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_9_amount"
                                            ...
                                            value="{{ old('implementation_mail_9_amount') ?? $payroll->implementation_mail_9_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_10_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_10_id') ?? $payroll->implementation_mail_10_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_10_amount"
                                            ...
                                            value="{{ old('implementation_mail_10_amount') ?? $payroll->implementation_mail_10_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_11_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_11_id') ?? $payroll->implementation_mail_11_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_11_amount"
                                            ...
                                            value="{{ old('implementation_mail_11_amount') ?? $payroll->implementation_mail_11_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_12_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_12_id') ?? $payroll->implementation_mail_12_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_12_amount"
                                            ...
                                            value="{{ old('implementation_mail_12_amount') ?? $payroll->implementation_mail_12_amount }}" />
                                ...
                                <div class="flex">
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_13_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_13_id') ?? $payroll->implementation_mail_13_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_13_amount"
                                            ...
                                            value="{{ old('implementation_mail_13_amount') ?? $payroll->implementation_mail_13_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_14_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_14_id') ?? $payroll->implementation_mail_14_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_14_amount"
                                            ...
                                            value="{{ old('implementation_mail_14_amount') ?? $payroll->implementation_mail_14_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_15_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_15_id') ?? $payroll->implementation_mail_15_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_15_amount"
                                            ...
                                            value="{{ old('implementation_mail_15_amount') ?? $payroll->implementation_mail_15_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_16_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_16_id') ?? $payroll->implementation_mail_16_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_16_amount"
                                            ...
                                            value="{{ old('implementation_mail_16_amount') ?? $payroll->implementation_mail_16_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_17_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_17_id') ?? $payroll->implementation_mail_17_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_17_amount"
                                            ...
                                            value="{{ old('implementation_mail_17_amount') ?? $payroll->implementation_mail_17_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_18_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_18_id') ?? $payroll->implementation_mail_18_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_18_amount"
                                            ...
                                            value="{{ old('implementation_mail_18_amount') ?? $payroll->implementation_mail_18_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_19_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_19_id') ?? $payroll->implementation_mail_19_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_19_amount"
                                            ...
                                            value="{{ old('implementation_mail_19_amount') ?? $payroll->implementation_mail_19_amount }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_20_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_20_id') ?? $payroll->implementation_mail_20_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_20_amount"
                                            ...
                                            value="{{ old('implementation_mail_20_amount') ?? $payroll->implementation_mail_20_amount }}" />
                                ...
                                <div class="flex">
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_21_id" class="w-48 block mt-1"
                                            ...
                                            value="{{ old('implementation_mail_21_id') ?? $payroll->implementation_mail_21_id }}" />
                                    ...
                                    <div class=" mx-4 my-4 w-48">
                                        ...
                                        <x-text-input id="implementation_mail_21_amount"
                                            ...
                                            value="{{ old('implementation_mail_21_amount') ?? $payroll->implementation_mail_21_amount }}" />
        ...
        $(document).ready(function() {
            ...
            $('input[type=checkbox]').each(function() {
                ...
                if ($(this).data('type') == 'dynamic' && eval($(this).data('sourcetype')) == 2) {
                    if ($('#' + $(this).data('input')).val() == eval($(this).data('source')) * salary_scale
                        .salary) {
                        //style
                        ...
                        //style background = yellow  with check box = true
                        $('#' + $(this).data('input')).prop(
                                'disabled',
                                false)
                    ...
                    if ($('#' + $(this).data('input')).val() == eval($(this).data('source'))) {
                        //style
                        $('#' + $(this).data('input')).prop(
                                'disabled',
                                true)
